...
const SLIDES: Slide[] = [
  ...
  { tag: 'National Reach', title: 'Now delivering to all seven provinces', sub: 'Same online-first reach as Roofsteel and Bricksplaza.', ctaLabel: 'Check Delivery', ctaHref: '/store-locator', bg: '#3E6E91' },
];

export default function HeroSliderStore() {
